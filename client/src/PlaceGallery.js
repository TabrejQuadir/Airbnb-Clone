    ...
    <div className="relative">
      <div className="grid gap-2 grid-cols-[2fr_1fr_1fr] rounded-3xl overflow-hidden">
        ...
        <div className="grid ">
          ...
          <div className="overflow-hidden relative top-2">
            {place.photos?.[2] && (
        ...
        <div className="grid ">
          {place.photos?.[3] && (
            <Image onClick={() => setShowAllPhotos(true)} className="aspect-square cursor-pointer object-cover" src={place.photos[3]} alt=""/>
          )}
          <div className="overflow-hidden relative top-2">
            {place.photos?.[4] && (
              <Image onClick={() => setShowAllPhotos(true)} className="aspect-square cursor-pointer object-cover relative " src={place.photos[4]} alt=""/>
            )}
          </div>
        </div>
